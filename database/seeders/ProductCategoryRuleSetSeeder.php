...
class ProductCategoryRuleSetSeeder extends Seeder
{
    ...
    private static function keywords(): array
    {
        return [
            ...
            'Инъекции' => 'амп|амп.|ампула|ампулы|инъ|инъ.|инъек|инъекция|инъекции|инъекций|р-р д/ин|р-р д/ин.|р-р д/инъ|р-р д/инъ.|р-р для инъ|р-р для инъекции|р/р для инъ|пор д/ин|пор. д/ин|пор д/инъ|пор. д/инъ.|д/ин|д/ин.|д-ин|д-ин.|р-р д/инф|р-р д/инф.|р-р для инф|р-р для инфузии|р-р для инфузий|р-р инфуз|р-р инфуз.|инфуз|инфуз.|инфузия|инфузии|инфузий|в/м|в-м|в/в|в-в|п/к|п-к|лиоф. пор. д/ин.|лиоф. пор. д-ин.',
    ...
    private static function supersedes(ProductCategory $category, string $keyword): array
    {
        return match ($category) {
            ProductCategory::Inhalations, ProductCategory::Injections, ProductCategory::Suspension => ['Раствор', 'Порошок'],
