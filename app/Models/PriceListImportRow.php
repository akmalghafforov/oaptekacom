...
class PriceListImportRow extends Model
{
    ...
    {
        return ['raw_values' => 'array', 'parsed_values' => 'array', 'errors' => 'array', 'warnings' => 'array', 'disposition' => PriceListRowDisposition::class, 'planned_action' => PriceListRowAction::class];
    }
}
