...
<x-ui.input name="phone" label="Телефон" :value="$phone" required readonly />
<x-ui.input name="code" label="Код из SMS" inputmode="numeric" autocomplete="one-time-code" required autofocus />
