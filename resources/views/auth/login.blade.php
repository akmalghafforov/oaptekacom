...
<div class="mt-5 flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-muted"><a class="font-semibold text-brand-700 hover:underline" href="{{ route('provider.login') }}">Вход для поставщиков</a></div>
@endsection
