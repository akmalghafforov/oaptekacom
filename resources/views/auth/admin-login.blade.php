@extends('layouts.app')
@section('content')
<x-ui.page-header title="Вход для администратора" description="Используйте учётные данные администратора OAPTEKA." />
<x-ui.card><form method="post" action="{{ route('admin.login.authenticate') }}" class="space-y-5">@csrf
