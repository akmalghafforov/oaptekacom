...
@php
    $labels = [
        ...
        'completed' => 'Активен', 'active' => 'Активна', 'blocked' => 'Заблокирована', 'superseded' => 'Заменён', 'failed' => 'Ошибка',
    ];
    $positive = ['received', 'confirmed', 'received_by_customer', 'approved', 'completed', 'active'];
