...
class PharmacySubscriptionAuthorizationTest extends TestCase
{
    ...
    public function test_pending_payment_request_blocks_pharmacy_until_an_admin_activates_it(): void
    {
        ...
        $this->actingAs($pharmacy)
            ->post(route('subscription.requests.store'), ['plan' => SubscriptionPlan::Base->value, 'term' => SubscriptionTerm::ThreeMonths->value])
